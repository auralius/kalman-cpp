...
void EKF::EKalmanf(const colvec& u, const int k)
{  
...
void EKF::EKalmanf(const colvec& z, const colvec& u, const int k)
{    
  CalcF(x_m_, u, k);
  CalcH(x_m_, u, k);
