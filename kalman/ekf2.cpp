...
colvec EKF2::f(const colvec &x, const colvec &u, const int k)
{
    colvec xk(nOutputs_);
    xk = xk.zeros();
    return xk;
...
colvec EKF2::h(const colvec &x, const colvec &u, const int k)
{
    colvec zk(nOutputs_);
    zk = zk.zeros();
    return zk;
...
mat EKF2::CalcFx(const colvec &x, const colvec &u, const int k)
{
    mat F;
...
mat EKF2::CalcHx(const colvec &x, const colvec &u, const int k)
{
    mat H;
...
mat EKF2::CalcFxx(const colvec &x, const colvec &u, const int k, const int i)
{
    mat F2;
...
mat EKF2::CalcHxx(const colvec &x, const colvec &u, const int k, const int i)
{
    mat H2;
...
void EKF2::EKalmanf(const colvec& u, const int k)
{
...
void EKF2::EKalmanf(const colvec& z, const colvec& u, const int k)
{
    mat Fx = CalcFx(x_m_, u, k);
    mat Hx = CalcHx(x_m_, u, k);
